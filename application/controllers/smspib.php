...
class Smspib extends CI_Controller {
    ...
    public function index() {
        $config['base_url'] = "http://".$_SERVER['HTTP_HOST']."/ci_crud/smspib/index";
        $config['total_rows'] = $this->db->count_all('master_sms_preprocessing');
        $config['per_page'] = "10";
        ...
        $data['smspib'] = $this->msmspib->getAllSms($config["per_page"], $data['page']); //query model semua barang
